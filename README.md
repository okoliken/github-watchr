...
The payload works out of the box with most webhook services. For Discord, change the text key to content. For Slack, it already matches the expected text field format.
